...
const Prism: React.FC<PrismProps> = ({
  ...
  useEffect(() => {
    ...
    const fragment = `
      ...
      uniform float iTime;
      uniform float uHeight, uBaseHalf, uGlow, uNoise, uSaturation, uScale, uHueShift, uColorFreq, uBloom, uCenterShift, uInvBaseHalf, uInvHeight, uMinAxis, uPxScale, uTimeScale;
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uBloom: { value: BLOOM },
        // ↓ center moved down by centerOffset
        uCenterShift: { value: H * (0.25 + centerOffset) },
    ...
    hueShift, colorFrequency, timeScale, hoverStrength, inertia, bloom, suspendWhenOffscreen, centerOffset
  ]);
